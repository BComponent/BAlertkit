...
#define defaultGroupID @"defaultGroupID"
///弹窗场景类型
...
@interface BPopupConfigure : NSObject<NSCopying>

/// 弹窗唯一标识
@property (nonatomic, copy) NSString *identifier;

///是否自动弹出下一个弹框，默认为NO
///手动弹出如果需要弹出下一个弹框，需要手动调弹出方法
@property (nonatomic, assign) BOOL autoPop;

/// 优先级 范围0~1000 (默认0,数值越大优先级越高，相同登记先进后出)
@property (nonatomic, assign) CGFloat priority;

///弹出是controller类型 默认NO
@property (nonatomic, assign) BOOL popIsControllerView;
